...
//            System.out.println("APP5--Service Disconnected--");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_service_bind);
        ...
        bindStatus.setOnClickListener(view -> Toast.makeText(ServiceBindActivity.this, "APP5-Service 的count 值为：" + binder.getCount(), Toast.LENGTH_SHORT).show());
    }
}
